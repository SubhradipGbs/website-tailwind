      ...
      <div className="grid grid-cols-1 md:grid-cols-2 bg-gradient-to-r from-blue-700 to-blue-500 text-white px-4 py-12 lg:p-8">
        <div className="container px-4 md:px-6 flex flex-col gap-6 justify-center items-start max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button className="bg-white text-blue-600 hover:bg-gray-200 hover:text-black rounded px-4 py-2">
              Talk to an Expert
            </Button>
            <Button className="bg-yellow-400 text-black hover:bg-yellow-300 rounded px-4 py-2">
          ...
          {servceSlides.map((slide, index) => (
            <div key={index} className="w-full flex-shrink-0">
              <div className="flex flex-col items-center justify-center h-full p-6">
                <h2 className="text-[1.2rem] md:text-[1.5rem] lg:text[1.8rem] font-bold mb-4 text-center">{slide.title}</h2>
                <p className="text-sm md:text-md lg:text-lg xl:text-xl mb-4 text-center">{slide.description}</p>
                <Button
