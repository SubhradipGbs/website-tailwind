...
const About = () => {
  return (
    <Section className="bg-gray-100" customPaddings="py-12 lg:py-20">
      <div className="bg-white py-6 px-[2rem] md:px-[3rem] lg:px-[5rem] xl:px-[7rem]">
        <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex justify-center">
            <img
              src="/LOGO_NEW_01.png"
              alt="Logo"
              className="h-xl w-auto object-contain"
            />
          </div>
          ...
          <div className="flex flex-col gap-6 text-gray-700">
            ...
            <h2 className="text-blue-700 text-xl md:text-2xl font-semibold leading-snug">
            ...
            <div className="mt-6">
              <button className="bg-blue-700 hover:bg-blue-800 text-white px-6 py-2 rounded-full transition-transform hover:-translate-y-1 cursor-pointer font-semibold">
                Learn More About Us
              </button>
            </div>
          </div>
      ...
      {/* Statistics Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 items-center mt-10 px-6 md:px-10 py-10 mx-auto md:mx-5 lg:mx-10 xl:mx-12">
        {/* Statistics Cards */}
        {[
          {
            count: "500+",
          ...
          <div
            key={i}
            className="flex flex-col justify-center items-center bg-white p-6 rounded-lg shadow-lg"
          >
            <h1 className="text-blue-700 text-[2.5rem] font-bold mb-4 text-center">
              {item.count}
            </h1>
