...
const About = () => {
  return (
    <Section id="about" className="bg-gray-100 py-12 lg:py-20 dark:bg-gray-900">
      <div className="bg-white py-6 px-4 md:px-6 lg:px-10 xl:px-14 dark:bg-gray-800">
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="flex flex-col gap-6 text-gray-700 dark:text-gray-200">
            ...
            <p className="text-base leading-relaxed text-justify">
              ...
              <strong> ISO 9001:2015</strong> certified organization, GBS
              ensures compliance, quality, and security across every project.
              Our approach begins with understanding our client's business goals
              and delivering the right mix of <strong>SAP services</strong>,
            ...
            <p className="text-base leading-relaxed text-justify">
              ...
              <strong> GIS</strong> & <strong>drone-based surveying</strong>,
              and enterprise IT development, we help clients streamline
              processes, improve data visibility, and achieve sustainable growth
              across industries.
            </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-center mt-10 px-4 md:px-6 lg:px-10 py-10 mx-auto">
        ...
        {[
          ...
          >
            <h1 className="text-blue-700 text-[2rem] md:text-[2.5rem] font-bold mb-4 text-center dark:text-blue-400">
              <CountUp
                start={0}
                end={item.count}
                suffix="+"
