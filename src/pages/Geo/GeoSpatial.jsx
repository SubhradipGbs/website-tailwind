...
const GeoSpatial = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>GBS Geospatial Services - Indoor and Outdoor Solutions</title>
        <meta
          name='description'
          content='Explore GBS Geospatial Services for indoor and outdoor mapping, surveying, and data analytics. Delivering precision data for engineering, infrastructure, and asset management.'
        />
        <meta
          name='keywords'
          content='Geospatial Services, Indoor Mapping, Outdoor Surveying, GIS, CAD, BIM, LiDAR, Drone Surveys, GBS Geospatial'
        />
        <meta name='author' content='GBS IT Consulting and Services Company' />
      </Helmet>
      <Section
        ...
        <div className='relative h-[95vh] md:h-[90vh] w-full overflow-hidden'>
          ...
          <video
            ...
            muted
            playsInline>
            <source src='/Deocha_Sample_video.webm' type='video/webm' />
      ...
      <Section className='bg-gray-100'>
        <h1 className='text-3xl font-bold text-center mb-2'>Our Clients</h1>
        <p className='text-sm md:text-md lg:text-lg xl:text-xl text-center text-gray-600 max-w-[700px] mx-auto mb-8'>
