...
const ITPage = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>GBS IT Services - Enterprise IT Solutions and Consulting</title>
        <meta
          name='description'
          content='Explore GBS IT Services for enterprise IT solutions, custom software development, and consulting. Transform your business with our expert IT services.'
        />
        <meta
          name='keywords'
          content='IT services, enterprise IT solutions, custom software development, IT consulting, GBS IT'
        />
